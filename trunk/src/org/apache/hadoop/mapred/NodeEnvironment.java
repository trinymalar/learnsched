...
class NodeEnvironment {
  ...
  public String toString() {
    ...
    builder.append(loadAverage); builder.append('\t');
    builder.append(this.numMaps); builder.append('\t');
    builder.append(this.numReduces); builder.append('\t');
    builder.append(this.memUsed); builder.append('\t');
    builder.append(this.swapUsed); builder.append('\t');
    builder.append(this.diskio); builder.append('\t');
    builder.append(this.netio); builder.append('\t');
    builder.append(this.ucpu); builder.append('\t');
    builder.append(this.numCpus); builder.append('\t');
    builder.append(this.cpuFreq); builder.append('\t');
    builder.append(this.memTotal); builder.append('\t');
    builder.append(this.swapTotal); builder.append('\t');
